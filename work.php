...
<div class="container" style="margin-top: 117px;">
    <div class="row">
        <div class="col-md-8" >
            ...
            <section style=" width: 100%; height: 500px; padding: 0">
                <div class="text-center col-sm-6" style="margin-top: 10%; ">
                    <form  method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="cv">Upload CV/Resume</label>
                                  <input type="file" id="cv" name="fileUrl" class="form-control" aria-describedby="fileType" required/>
                                    
                                    <p id="fileType" class="form-text text-muted">
                                         only .pdf,.doc
                                    </p>
                        </div>
                         <div class="form-group">
                            <button class="btn btn-success" type="submit" name="addfile">upload</button>
                        </div>
                    </form>
                ...
                if(isset($_POST['addfile'])) {
                    ...
                    $sql_url="insert into fileupload (fileUrl,date) VALUES ('".$url."','$today')";
                    if(mysqli_query($conn,$sql_url)){
                        echo"
                            <script>alert('Thank You')</script>
                            ";
                    }
