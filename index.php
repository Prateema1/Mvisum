    ...
    <div class="row">
                ...
                <div id="myCarousel" class="carousel slide" data-ride="carousel" style="z-index: -1">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="images/study-in-usa1.jpg" alt="Los Angeles" style="width:100%;">
                        </div>

                        <div class="item">
                            <img src="images/STUDY-IN-CANADA.jpg" alt="Chicago" style="width:100%;">
                        </div>

                        <div class="item">
                            <img src="images/study%20in%20abrode.jpg" alt="New york" style="width:100%;">
                        </div>
                    </div>
                </div>
            </section>
        ...
        <div class="col-md-4">
            ...
            <div class="col">
                ...
                <div class="col-xs-12 text-center">
                    <a href="panel/index.php"><button class="btn btn-danger">Admin Portal</button></a>
                </div>
            </div>
        </div>
    </div>
