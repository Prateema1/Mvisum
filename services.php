...
if(isset($_REQUEST['id'])){
    $sql_serv = "select * from services WHERE id='$_REQUEST[id]'";
    $run_serv = mysqli_query($conn,$sql_serv);
    $row_serv = mysqli_fetch_assoc($run_serv);
...
<div class="container" style="margin-top: 117px;">
    <div class="row">
        <div class="col-md-8" >
            ...
            <section style="font-family: 'Times New Roman'; width: 100%;text-align: justify !important; height: 500px; padding: 0">
                <?php
                echo"
                       <h4 style='color: blue; text-decoration: underline' >$row_serv[serviceType]</h4>
                       <p>
                        $row_serv[serviceDetail]
                        </p>
                    ";
                ?>
            </section>
