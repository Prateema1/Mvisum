...
if(isset($_REQUEST['id'])){
    $sql_visa = "select * from visa WHERE id='$_REQUEST[id]'";
    $runs_visa = mysqli_query($conn,$sql_visa);
}
...
<div class="container" style="margin-top: 117px;">
    <div class="row">
        <div class="col-md-8" >
            ...
            <section style=" width: 100%; height: 500px;font-family: 'Times New Roman'; text-align: justify !important; padding: 0">
                <?php
                while ($rows_visad = mysqli_fetch_assoc($runs_visa)){
                    echo"
                    <h4 style='color: blue ; text-decoration: underline'>$rows_visad[visaType]</h4>
                    <p>$rows_visad[visaDetail]</p>
                    ";
                }
                ?>
            </section>
