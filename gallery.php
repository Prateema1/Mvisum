...
<div class="container" style="margin-top: 117px;">
    <div class="row">
        <div class="col-md-8" >
            ...
            <section style="width: 100%; height: 500px; overflow: scroll; padding: 0">
                <div class="row">
                    <?php
                    $path="gallery/";
                    $sql_gal = "select * from gallery";
                    $run_gal = mysqli_query($conn,$sql_gal);
                    while($rows_gal = mysqli_fetch_assoc($run_gal)){
                        echo"
                        <div class='col-md-4' style='z-index: -1'>
                        <div class='thumbnail'>
                            <a href='gallery/$rows_gal[image]' target='_blank'>
                                <img src='gallery/$rows_gal[image]' alt='image' style='width:100%;'>
                                <div class='caption'>
                                    <p>$rows_gal[description]</p>
                                </div>
                            </a>
                        </div>
                    </div>
