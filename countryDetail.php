...
if(isset($_REQUEST['id'])){
    $sql_detail = "select * from countries WHERE id='$_REQUEST[id]'";
...
<div class="container" style="margin-top: 117px;">
    <div class="row">
        <div class="col-md-8" >
            ...
            <section style="font-family: 'Times New Roman';overflow: scroll; width: 100%; height: 500px; padding: 0">
                <?php
                     echo"
                       <h4><b><u>$row_detail[country]</u></b></h4>
                       <ul class='tick'>
                       $row_detail[detail]
                       </ul>
                    ";
                if($row_detail['intakes']){
                    echo"
                    <h4><u>Intakes</u></h4>
                    <ul class='tick'>
                    $row_detail[intakes]
                ...
                if($row_detail['universities']){
                    echo"
                    <h4><u>Name of the Universities, Campuses</u></h4>
                    <ul class='tick'>
                    $row_detail[universities]
                    </ul>
                    ";
                }
                ?>
